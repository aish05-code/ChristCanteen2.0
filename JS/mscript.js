const items = [
    { name: "Cold Chocolate", price: 40, image: "cold_choclate.jpg" },
    { name: "Coffee", price: 20, image: "coffee.jpeg" },
    { name: "Tea", price: 20, image: "tea.jpg" },
    { name: "Vada Pav", price: 60, image: "vada_pav.JPG" },
    { name: "Chicken Cheese Sandwich", price: 70, image: "chicken_sandwich.jpg" },
    { name: "Chicken Cheese Burger", price: 60, image: "chicken_burger.jpeg" },
    { name: "Veg Cheese Burger", price: 55, image: "veg_burger.jpeg" },
    { name: "Veg Sandwich", price: 50, image: "veg_sandwich.jpg" },
    { name: "French Fries", price: 35, image: "french_fries.jpg" }
];
